                ...
                <li ng-repeat="day in my_days">
                    ...
                    <div collapse="day.is_collapsed">
                        <div class="well well-lg">
                            ...
                            <fieldset>
                                ...
                                <div style="padding:4px; border: 1px solid #C0C0C0;-moz-border-radius: 4px;-webkit-border-radius: 4px;">
                                    <div ng-repeat="place in day.places">
                                        <a ng-click="open_marker_modal(place, false, day.is_editable)">{{place.name}}</a>
                            ...
                            <button typev="button" ng-disabled="day_is_editable(day)" ng-click="set_day_editable(day)">Edit</button>
                            <button type="button" ng-disabled="!day_has_been_modified(day)" ng-click="save_modified_day(day)">Save</button>
